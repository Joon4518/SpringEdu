			...
			<div class="panel-body">
				...
				<form id="frm" method="get" action="">
					<table class="table table-bordered table-hover">
						...
						<tr>
							<td>내용</td>
							<td><textarea id="content" name="content" class="form-control" rows="10" cols=""><c:out value='${vo.content}' /></textarea></td>
						</tr>
						<tr>
							<td>작성자</td>
							<td><input id="writer" value="${vo.writer}" readonly="readonly"
						...
						<tr>
							<td colspan="2" style="text-align: center;"><c:if
									...
									<button disabled="disabled" type="submit"
										class="btn btn-sm btn-primary">수정</button>
									<button disabled="disabled" type="button" data-btn="remove"
										class="btn btn-sm btn-success">삭제</button>
								</c:if>
