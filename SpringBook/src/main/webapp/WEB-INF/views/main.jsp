	  ...
	  <div class="panel panel-default">
		...
		<div class="panel-body" id="uform" style="display : none;">
			...
			<table class="table">
				<tr>
					<td>제목</td>
					<td><input  type="text" name="title" id="title" class="form-control" readonly="readonly">span</td>
				</tr>
				<tr>
					<td>작가</td>
					<td><input type="text" name="author" id="author" class="form-control" readonly="readonly"></a></td>
				</tr>
				<tr>
					<td>출판사</td>
					<td><input type="text" name="company" id="company" class="form-control" readonly="readonly"></td>
				</tr>
				
				<tr>
					<td>isbn</td>
					<td><input type="text" name="isbn" id="isbn"class="form-control" readonly="readonly"></td>
				</tr>
				
				<tr>
					<td>보유도서수</td>
					<td><input type="text" name="count" id="count" class="form-control"></td>
				</tr>
				<tr>
					<td colspan="2" align="center" id="updateBtn">
...
/* 				listHtml += "<br>";
		...
		// goForm 함수를 만들어서 view는 감추boardList고 wform은 보이게하시오
		function goForm(){
		...
		function goUpdateForm(num){
			...
			$.ajax({
				...
				success : function(data) {
					...
					$("#updateBtn").html('<button class="btn btn-success btn-sm" type="button" onclick="goUpdate('+num+')">수정</button>'+
					'<button class="btn btn-warning btn-sm" type="reset" id="fclear">취소</button>'+
					'<button onclick="goList()" class="btn btn-info btn-sm">리스트로가기</button>');
